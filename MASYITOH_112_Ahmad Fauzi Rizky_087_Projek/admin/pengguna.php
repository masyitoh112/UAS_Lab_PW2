...
<div class="content">
    <div class="container">
        <div class="box">
            <div class="box-header"> Pengguna </div>
            <div class="box-body">
                ...
                <table class="table">
                    ...
                    ?> <tr>
                            ...
                            <td><?= $p['level'] ?></td>
                            <td>
                                <a href="edit-pengguna.php?id=<?= $p['id'] ?>" tittle="Edit Data" class="text-orange"><i
                                        class="fa fa-edit"></i></a>
                                <a href="hapus.php?idpengguna=<?= $p['id'] ?>"
                                    onclick="return confirm('Yakin ingin hapus?')" tittle=" Hapus Data"
